          ...
          <el-collapse-transition>
            <div v-show="show">
              ...
              <el-form-item label="发布时间：">
                <el-link
                  :underline="false"
                  :class="{'active': formParams.fb_time == item.value}"
                  @click="selectQuery('fb_time',item)"
              ...
              <el-form-item label="上架状态：">
                <el-link
                  :underline="false"
                  :class="{'active': formParams.jobStatus == item.value}"
              ...
              <el-form-item label="岗位类型：">
                <el-link
                  :underline="false"
                  :class="{'active': formParams.jobType == item.value}"
              ...
              <el-form-item label="返利模式：">
                <el-link
                  :underline="false"
                  :class="{'active': formParams.reward_type == item.value}"
              ...
              <el-form-item label="薪资类型：">
                <el-link
                  :underline="false"
                  :class="{'active': formParams.money_type == item.value}"
          ...
          <el-table-column label="上架状态" prop="state" align="center" min-width="200">
            <template slot-scope="scope">
              <el-button
                ...
                size="small">
                <i 
                :class="scope.row.is_up==null ? 'el-icon-minus' : scope.row.is_up=='1' ? 'el-icon-circle-check' : 'el-icon-close' "
                ></i>
              </el-button>
            </template>
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      handleDetail (v) {
        ...
        this.$router.push({ path: 'innDetail', query: { val: v } })
